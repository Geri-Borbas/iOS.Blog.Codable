...
class PropertyWrapperSpec: QuickSpec {
	
	override func spec() {
		
		describe("\(PropertyWrapper.self)") {
			...
			it("should be able access data directly") {
